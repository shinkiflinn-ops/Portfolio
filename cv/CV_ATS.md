...
- Électronique Pratique et Conception : Conception et assemblage de circuits sur breadboard, logique séquentielle (timers NE555, compteurs 74LS90), test de composants.
- Systèmes d'Exploitation : Linux (Pop!_OS).
- Compétences comportementales (Soft Skills) : Esprit d'analyse, travail en équipe (collaborations régulières avec d'autres passionnés), apprentissage autonome et résolution de problèmes.
...
- Anglais : Technique (Compréhension de documentations techniques en développement et électronique).
